...
use super::rows::{
    spawn_insight_row, spawn_item_button, spawn_level_history_rows, spawn_stat_row,
    spawn_stat_section_header, spawn_stat_text_row, update_detail_panel,
};
...
pub(super) fn team_label_color(label: &str) -> Color {
    match label {
