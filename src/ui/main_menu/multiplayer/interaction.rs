//! Multiplayer menu interaction: button actions and lobby message processing.

use super::setup::{
    build_opponent_status_text, load_my_unlocked_content, spawn_ready_button_contents,
