...
/// Button style for selected ingredient toggle — purple active look.
pub const INGREDIENT_SELECTED_STYLE: ButtonStyle = ButtonStyle {
    width: BUTTON_WIDTH,
    height: BUTTON_HEIGHT,
    border_width: BUTTON_BORDER_WIDTH,
    font_size: BUTTON_FONT_SIZE,
    background: Color::hsla(270.0, 0.25, 0.16, 0.8),
    border: Color::hsla(270.0, 0.40, 0.40, 0.8),
    text_color: Color::hsla(270.0, 0.20, 0.90, 1.0),
    text_shadow: true,
};
