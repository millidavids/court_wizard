...
pub(super) const LEFT_WALL_WIDTH: f32 = LEFT_WALL_HEIGHT * (LEFT_WALL_IMAGE_WIDTH / LEFT_WALL_IMAGE_HEIGHT);
...
pub(super) const LAVA_POOL_POSITION: Vec3 = Vec3::new(2500.0, 2.0, -750.0);
/// Approximate radius of the lava pool for particle spread.
pub(super) const LAVA_POOL_RADIUS: f32 = 400.0;

/// World position of the water pool (approx pixel 50, 55).
pub(super) const WATER_POOL_POSITION: Vec3 = Vec3::new(2075.0, 3.0, -2510.0);
/// Approximate radius of the water pool for ripple effect.
pub(super) const WATER_POOL_RADIUS: f32 = 700.0;
