...
pub(super) const LAVENDER_CONFIG: IngredientConfig = IngredientConfig {
    name: "Lavender",
    description: "A fragrant purple shrub that carpets sun-baked hillsides and dry meadows. Its slender flower spikes release a calming scent prized by healers and mages alike. Increases mana regeneration.",
...
pub(super) const MUGWORT_CONFIG: IngredientConfig = IngredientConfig {
    name: "Mugwort",
    description: "A tall, silvery-leafed weed that thrives along roadsides and riverbanks. Its downy underside glows faintly in moonlight, hinting at its arcane potency. Increases spell power.",
...
pub(super) const YARROW_CONFIG: IngredientConfig = IngredientConfig {
    name: "Yarrow",
    description: "A hardy wildflower with flat clusters of tiny white blossoms and feathery leaves. It grows in open grasslands and along dusty field edges. Heals defender units over time.",
...
pub(super) const MISTLETOE_CONFIG: IngredientConfig = IngredientConfig {
    name: "Mistletoe",
    description: "A parasitic evergreen found tangled high in oak branches, bearing pale green leaves and waxy white berries. Druids harvested it with golden sickles at midwinter. Defenders deal more damage.",
...
pub(super) const VERVAIN_CONFIG: IngredientConfig = IngredientConfig {
    name: "Vervain",
    description: "A slender herb with small lilac flowers that grows in dry ditches and along crumbling stone walls. Long considered sacred by enchanters for its ability to quicken rituals. Increases spell casting speed.",
...
pub(super) const WORMWOOD_CONFIG: IngredientConfig = IngredientConfig {
    name: "Wormwood",
    description: "A bitter, grey-green shrub with deeply lobed leaves that flourishes in rocky wastelands and abandoned ruins. Its pungent oil wards off both insects and blades. Defenders take less damage.",
...
pub(super) const BLUE_LOTUS_CONFIG: IngredientConfig = IngredientConfig {
    name: "Blue Lotus",
    description: "A striking water flower with vivid blue petals that floats on still temple pools and warm river deltas. Its intoxicating fragrance expands the mind — and spell radius. Increases spell area of effect.",
...
pub(super) const MEADOWSWEET_CONFIG: IngredientConfig = IngredientConfig {
    name: "Meadowsweet",
    description: "A frothy-topped plant with creamy white blossoms that sways in damp meadows and along stream banks. Its sweet, almond-like scent invigorates those who breathe it in. Defenders move faster.",
...
pub(super) const VALERIAN_CONFIG: IngredientConfig = IngredientConfig {
    name: "Valerian",
    description: "A tall plant with dense pink flower heads and a thick, pungent root found in wet woodland clearings. Its earthy smell is overwhelming — and deeply sedating. Slows enemy movement.",
...
pub(super) const NATRON_SALT_CONFIG: IngredientConfig = IngredientConfig {
    name: "Natron Salt",
    description: "A chalky white mineral scraped from the shores of dried desert lakes. Ancient embalmers used it to preserve the dead; alchemists use it to preserve the living. Shields defenders with temporary health.",
...
pub(super) const LAPIS_LAZULI_CONFIG: IngredientConfig = IngredientConfig {
    name: "Lapis Lazuli",
    description: "A deep blue gemstone flecked with golden pyrite, mined from mountain caves in arid highlands. Mages have carved it into wands and amulets for centuries. Increases maximum mana capacity.",
...
pub(super) const HENBANE_CONFIG: IngredientConfig = IngredientConfig {
    name: "Henbane",
    description: "A sinister-looking plant with sticky, hairy stems and pale yellow flowers veined in purple. It sprouts in graveyards and disturbed soil. Defenders attack faster.",
...
pub(super) const FRANKINCENSE_CONFIG: IngredientConfig = IngredientConfig {
    name: "Frankincense",
    description: "A golden, tear-shaped resin that oozes from the bark of gnarled trees clinging to desert cliffs. When burned, its thick smoke carries spells further and harder. Increases spell power.",
...
pub(super) const AMBER_CONFIG: IngredientConfig = IngredientConfig {
    name: "Amber",
    description: "A warm, translucent gemstone of fossilized tree resin, often found washed ashore on cold northern beaches or buried in ancient pine forests. It traps time itself within its glow. Brew buffs last longer.",
...
pub(super) const RAVEN_FEATHER_CONFIG: IngredientConfig = IngredientConfig {
    name: "Raven Feather",
    description: "An iridescent black feather with a faint blue-violet sheen, plucked from ravens that roost on ancient battlefields and gallows hills. It hums with gathered wisdom. Boosts defender effectiveness.",
...
pub(super) const MANDRAKE_ROOT_CONFIG: IngredientConfig = IngredientConfig {
    name: "Mandrake Root",
    description: "A forked, pale root with an unsettling resemblance to a human figure, dug from rich soil beneath gallows trees. Harvesters stuff their ears with wax before pulling it. Increases spell casting speed.",
...
pub(super) const ROWAN_BERRY_CONFIG: IngredientConfig = IngredientConfig {
    name: "Rowan Berry",
    description: "Bright red-orange berries that grow in dense clusters on mountain rowan trees. Found at forest edges and highland passes, they have long been strung above doorways to repel evil. Defenders take less damage.",
...
pub(super) const DRAGONS_BLOOD_CONFIG: IngredientConfig = IngredientConfig {
    name: "Dragon's Blood",
    description: "A dark crimson resin harvested from thorny tropical trees that grow in volcanic soil. It bleeds from cuts in the bark and dries into brittle, blood-red flakes. Defenders deal more damage.",
