            ...
            .add_systems(
                ...
                (
                    ...
                    update_wizard_cycle_flash
                        .run_if(crate::game::run_conditions::any_exist::<super::components::WizardCycleFlash>()),
...
fn animate_fortified_horde_glow(
    time: Res<Time>,
