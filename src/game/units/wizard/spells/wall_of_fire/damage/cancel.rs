use super::super::super::super::components::CastingState;
use super::super::super::super::components::LocalWizard;
use super::super::components::WallOfFireCaster;
use crate::game::input::MouseButtonState;
use bevy::prelude::*;

/// Handles right-click cancellation of a wall of fire being placed.
