        ...
        app.add_systems(
            ...
            (
                ...
                (
                    ...
                    systems::apply_cleansing_plume.run_if(any_exist::<CleansingPlumeZone>()),
                    // Tier 3: Font of Life — detect deaths in zone
                    systems::font_of_life_detect_deaths.run_if(any_exist::<FontOfLifeZone>()),
                    // Tier 3: Healing Rain — move zone toward cursor
                    systems::move_healing_rain_zones.run_if(any_exist::<HealingRainZone>()),
