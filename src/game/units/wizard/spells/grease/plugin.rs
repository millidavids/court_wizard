    ...
    fn build(&self, app: &mut App) {
        app.add_systems(
            ...
            (
                ...
                systems::spawn_grease_zone_vfx.run_if(any_exist::<GreaseZone>()),
                // Bubble and splatter update systems
                systems::update_grease_bubbles.run_if(any_exist::<GreaseBubble>()),
                systems::update_grease_splatters.run_if(any_exist::<GreaseSplatter>()),
