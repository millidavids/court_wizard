...
pub fn handle_berserker_rage_casting(
    ...
    let cast_result = berserker_rage_casting_logic(
        &input,
        &time,
        &mut casting_state,
        &mut mana,
...
/// Guest wizard berserker rage casting -- reads network signals.
#[allow(clippy::too_many_arguments)]
pub fn handle_berserker_rage_casting_guest(
    time: Res<Time>,
    mut commands: Commands,
    mut wizard_query: Query<
        (
...
/// Core berserker rage casting logic -- called by both local and guest systems.
///
