//! Local-only cast VFX helpers: flares, motes, smoke poofs, dust smoke, and aura bubbles.

use bevy::prelude::*;

use super::super::area_effects::spawn_fire_smoke_puff;
use super::super::components::{AuraBubbleVfx, CastFlare, FireSpark, FloatingMote, SmokePoof};
