...
/// Tracks the boss's enrage state which activates at HP thresholds.
#[derive(Component)]
...
/// Cooldown timer for the boss's melee attacks (separate from global attack cycle).
#[derive(Component)]
pub struct BossAttackCooldown {
    pub time_remaining: f32,
}

impl BossAttackCooldown {
    pub const fn new() -> Self {
        Self {
            time_remaining: 0.0,
        }
...
/// Applied by boss melee and ground slam attacks. Decays linearly
