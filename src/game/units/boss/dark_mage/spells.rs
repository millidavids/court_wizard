...
pub(super) fn telegraph_duration(spell: DarkMageSpellType) -> f32 {
    match spell {
...
pub(super) fn spell_cooldown(spell: DarkMageSpellType) -> f32 {
    match spell {
...
pub(super) fn find_spell_target(
...
pub(super) fn spawn_telegraph_indicators(
...
pub(super) fn spawn_lightning_strike(
    commands: &mut Commands,
    assets: &DarkMageAssets,
    spell_assets: &SpellVisualAssets,
    target_pos: Vec3,
