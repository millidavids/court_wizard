...
pub(super) fn is_valid_target(source_team: &Team, target_team: &Team) -> bool {
...
pub(super) fn wall_near_approach_path(walls: &[&WallOfStone], from: Vec3, to: Vec3) -> bool {
